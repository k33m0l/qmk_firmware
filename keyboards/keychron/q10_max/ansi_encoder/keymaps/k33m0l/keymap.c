...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [GAMER_BASE] = LAYOUT_ansi_90(
        ...
        MC_5,       KC_LCTL,    KC_LWIN,KC_LALT,KC_SPC, MO(WIN_FN),         KC_BSPC,                KC_RALT,KC_RCTL,    KC_LEFT,    KC_DOWN,    KC_RGHT),

    [GAMER_FN] = LAYOUT_ansi_90(
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
    [GAMER_BASE] = {ENCODER_CCW_CW(KC_VOLD, KC_VOLU)},
    [GAMER_FN] = {ENCODER_CCW_CW(RGB_VAD, RGB_VAI)},
